...
export default function Home() {
  ...
  return (
      <>
        <Head>
          <title>Ice of Cream</title>
          <meta name="description" content="Generated by ice of cream" />
            ...
            <section className="about" id="blog">
                ...
                <div 
                  ...
                  className="about-text">
                    ...
                    <p>The pleasure of enjoying a sweet treat like ice cream can release endorphins, giving you a momentary happiness boost. Remember, while it is okay to enjoy ice cream as a treat, balancing it with nutrient-rich foods like fruits and vegetables is key to maintaining overall well-being and a consistently positive mood.</p>
                    <a href="#menu" className="btn">Choose a Flavor</a>
                </div>
            </section>
